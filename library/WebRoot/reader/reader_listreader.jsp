...
<html>
  <head>
    ...
    <title>My JSP 'reader_listreader.jsp' starting page</title>
    ...
    <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF" >
         <tr><td colspan=3 align=center class=headline>维护读者信息</td></tr>
          <tr>
...
%>
                <tr>
                  ...
                  <a href="reader_updatereader.jsp?readerid=<%=readerid%>" onMouseOver="window.status='欢迎使用图书馆后台管理系统';return true;">| 修改</a>
                  <a href="reader_delete.jsp?readerid=<%=readerid%>" onMouseOver="window.status='欢迎使用图书馆后台管理系统';return true;">| 删除</a></td>
                </tr>
				<% 
				row=rs.getRow();
				}%>
