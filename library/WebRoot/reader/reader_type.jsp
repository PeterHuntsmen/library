...
<html>
  <head>
    ...
    <title>My JSP 'reader_type.jsp' starting page</title>
...
<table  width="600" border="0" cellpadding="0" cellspacing="0"  align="center">
 ...
 <tr> <td align=right><a href="reader\reader_type_addnew.jsp"><font size=2px>添加读者类型</font></a></td>
  </tr>
  <tr>
...
%>
                <tr>
                  ...
                  <a href="reader\reader_type_update.jsp?typeid=<%=typeid%>" onMouseOver="window.status='欢迎使用图书馆后台管理系统';return true;">修改</a>|&nbsp;
                  <a href="reader\reader_type_delete.jsp?typeid=<%=typeid%>" onMouseOver="window.status='欢迎使用图书馆后台管理系统';return true;">删除</a></td>
                </tr>
				<% 
				row=rs.getRow();
				}%>
