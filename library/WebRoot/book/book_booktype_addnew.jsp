...
<html>
  <head>
    ...
    <title>My JSP 'book_booktype_addnew.jsp' starting page</title>
...
<tr>
<td>
<p align="center"><font color="#000080" face="楷体_GB2312" size="4"><b>新增藏书类型</b></font><font color="#000080" face="楷体_GB2312" size="5">
</font>
</td></tr>
<tr>
<td>
<form  name="f1" action="book\book_booktype_add.jsp" method=post onsubmit="return check()">
<table>
<tr><td> 藏书类型:</td><td><input type=text name="typename"><font color="#FF0000">*</font></td>
</tr>
