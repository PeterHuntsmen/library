...
<html>
  <head>
    ...
    <title>My JSP 'book_bookclass.jsp' starting page</title>
...
<table  width="600" border="0" cellpadding="0" cellspacing="0"  align="center">
 ...
 <tr> <td align=right><a href="book_bookclass_addnew.jsp"><font size=2px>添加学科类型</font></a></td>
  </tr>
  <tr>
    ...
    <table  bgcolor="#FFFFFF" class=default align=center>
                ...
                <tr class=title>
                  <td width="193" height="25" align="center" valign="middle" >学科类型</td>
...
String classid=rs.getInt("classid")+"";
String classname=rs.getString("classname");
String demo=rs.getString("demo");
%>
                <tr>
                  <td height="25" align="center" valign="middle" class="unnamed1 style1"><%=classname%></td>
                  ...
                  <a href="book_bookclass_update.jsp?classid=<%=classid%>" >修改</a>|&nbsp;
                  <a href="book_bookclass_delete.jsp?classid=<%=classid%>" >删除</a></td>
                </tr>
				<% 
				row=rs.getRow();
				}%>
