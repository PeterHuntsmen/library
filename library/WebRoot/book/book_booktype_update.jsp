...
<html>
  <head>
    ...
    <title>My JSP 'book_booktype_update.jsp' starting page</title>
...
<tr>
<td>
<p align="center"><font color="#000080" face="楷体_GB2312" size="4"><b>修改藏书类型</b></font><font color="#000080" face="楷体_GB2312" size="5">
</font>
</td></tr>
<tr>
<td>
...
String sql="select * from book_type where typeid = "+typeid;
dbCon.getConnection();
...
%>
<form  name="f1" action="book\book_booktype_updatetype.jsp" method=post onsubmit="return check()">
<table>
<tr><td> 藏书类型:</td><td><input type="hidden" name=typeid value=<%=typeid %>>
